...
urlpatterns = [
    ...
    path('employee/<int:employee_id>/detail/', views.employee_detail_view, name='employee_detail'),
    
    # Company monitor dashboard
    path('company/<int:company_id>/monitor/', views.company_monitor_dashboard, name='company_monitor'),
