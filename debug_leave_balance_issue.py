...
def debug_leave_balances():
    ...
    for employee in employees:
        ...
        try:
            ...
            if balance.casual_leave_balance == expected_cl_balance:
                print("      ✅ CL Balance calculation correct")
            else:
            ...
            if balance.sick_leave_balance == expected_sl_balance:
                print("      ✅ SL Balance calculation correct")
            else:
            ...
            try:
                ...
                print("   ✅ Created new leave balance record")
    ...
    for balance in all_balances:
        try:
            balance.employee.user.get_full_name()
        except Exception:
