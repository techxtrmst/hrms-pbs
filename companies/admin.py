...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('name', 'primary_domain', 'email_domain', 'location', 'is_active', 'created_at')
...
class LocationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Domain Configuration', {
            'fields': ('primary_domain', 'allowed_domains', 'email_domain')
        }),
        ('Location & Contact', {
        ...
        ('Advanced', {
            'fields': ('db_schema', 'created_at', 'updated_at'),
            'classes': ('collapse',)
        }),
    )
...
class ShiftScheduleAdmin(admin.ModelAdmin):
    list_display = ('name', 'company', 'start_time', 'end_time', 'grace_period_minutes', 'is_active')
    search_fields = ('name', 'company__name')
    ...
    fieldsets = (
        ...
        ('Shift Timings', {
            'fields': ('start_time', 'end_time', 'lunch_break_start', 'lunch_break_end')
        }),
        ('Attendance Rules', {
