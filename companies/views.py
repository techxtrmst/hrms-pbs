...
from .models import Location, LocationWeekOff, ShiftSchedule, Company
...
def week_off_config(request):
    ...
    if selected_location_id:
        ...
        config, created = LocationWeekOff.objects.get_or_create(location=selected_location, defaults={'company': company})
        ...
        if request.method == 'POST':
            ...
            messages.success(request, f"Week-off configuration updated for {selected_location.name} and applied to {count} employees.")
    ...
    return render(request, 'companies/week_off_config.html', {
...
def role_configuration(request):
    ...
    return render(request, 'companies/role_configuration.html', {
