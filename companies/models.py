...
class Company(models.Model):
    ...
    hr_email = models.EmailField(blank=True, null=True, help_text="HR email address for sending birthday/anniversary emails")
    hr_email_password = models.CharField(max_length=255, blank=True, null=True, help_text="Email password or app password (encrypted in production)")
    hr_email_name = models.CharField(max_length=100, blank=True, null=True, default="HR Team", help_text="Display name for HR emails (e.g., 'Petabytz HR')")
...
class Holiday(models.Model):
    ...
    holiday_type = models.CharField(max_length=20, choices=HOLIDAY_TYPE_CHOICES, default='MANDATORY',
...
class ShiftSchedule(models.Model):
    ...
    allowed_late_logins = models.IntegerField(default=5, help_text="Number of allowed late logins per month before reaction")
    grace_exceeded_action = models.CharField(max_length=20, choices=GRACE_ACTION_CHOICES, default='HALF_DAY',
                                            help_text="Action to take when allowed late logins count is exceeded")
    
    early_departure_threshold_minutes = models.IntegerField(default=15, help_text="Minutes before shift end considered early departure")
...
class Announcement(models.Model):
    ...
    location = models.ForeignKey(Location, on_delete=models.CASCADE, blank=True, null=True, related_name='announcements', 
