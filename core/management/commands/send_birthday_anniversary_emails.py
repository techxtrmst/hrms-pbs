    ...
    def handle(self, *args, **options):
        ...
        for emp in all_employees:
            ...
            try:
                ...
                self.stdout.write(self.style.WARNING(f'Invalid timezone {tz_name} for {emp.user.get_full_name()}, using Asia/Kolkata'))
            ...
            if emp.date_of_joining and emp.date_of_joining.month == local_date.month and emp.date_of_joining.day == local_date.day:
            ...
            if emp.date_of_joining:
                ...
                if local_date == probation_end_date:
                    ...
                    self.stdout.write(f'   Probation completed: 3 months')
        ...
        if not test_mode:
            ...
            total_emails = birthday_emails_sent + anniversary_emails_sent + birthday_announcements_sent + anniversary_announcements_sent + probation_emails_sent
