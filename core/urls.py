...
urlpatterns = [
    ...
    path("me/leaves/cancel/<int:pk>/", views.cancel_leave_request, name="cancel_my_leave_request"),
    ...
    path("analytics/late-early/", attendance_late_early_report, name="attendance_late_early_report"),
    ...
    path("config/holidays/template/", views.download_holiday_template, name="download_holiday_template"),
