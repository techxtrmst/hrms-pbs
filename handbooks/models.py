...
class Handbook(models.Model):
    ...
    version = models.CharField(
        max_length=50,
        default="1.0",
        help_text="Version number of this handbook"
    )
    is_published = models.BooleanField(
        default=False,
        help_text="Only published handbooks are visible to employees"
    )
    effective_date = models.DateField(
        default=timezone.now,
        help_text="Date when this handbook becomes effective"
    )
    ...
    requires_acknowledgment = models.BooleanField(
        default=False,
        help_text="Employees must acknowledge reading this handbook"
    )
