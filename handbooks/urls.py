...
urlpatterns = [
    ...
    path(
        "<int:handbook_id>/acknowledge/",
        views.acknowledge_handbook,
        name="acknowledge_handbook",
    ),
    # Admin views
    ...
    path(
        "admin/<int:handbook_id>/edit/",
        views.admin_handbook_edit,
        name="admin_handbook_edit",
    ),
    path(
        "admin/<int:handbook_id>/report/",
