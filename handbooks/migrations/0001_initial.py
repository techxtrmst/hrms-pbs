...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="handbook_sections",
                        to="companies.company",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            model_name="handbook",
            index=models.Index(
                fields=["company", "location"], name="handbooks_h_company_818cba_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="handbook",
            index=models.Index(
                ...
                name="handbooks_h_is_publ_b33768_idx",
            ),
        ),
    ]
