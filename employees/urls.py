...
urlpatterns = [
    ...
    path('import/download-sample/', views.download_sample_import_file, name='download_sample_import_file'),
    ...
    path('api/attendance/<int:pk>/map-data/', views.get_attendance_map_data, name='api_attendance_map_data'),
    ...
    path('leave/configuration/accrue/', views.run_monthly_accrual, name='run_monthly_accrual'),
    path('leave/balance/<int:pk>/update/', views.update_leave_balance, name='update_leave_balance'),

    # Regularization
    path('regularization/apply/', views.RegularizationCreateView.as_view(), name='regularization_apply'),
    path('regularization/requests/', views.RegularizationListView.as_view(), name='regularization_list'),
    path('regularization/<int:pk>/approve/', views.approve_regularization, name='regularization_approve'),
    path('regularization/<int:pk>/reject/', views.reject_regularization, name='regularization_reject'),
    
    # Emergency Contacts
    path('emergency-contact/add/', views.add_emergency_contact, name='add_emergency_contact'),
    path('emergency-contact/<int:contact_id>/update/', views.update_emergency_contact, name='update_emergency_contact'),
