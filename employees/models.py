...
class Payslip(models.Model):
    ...
    # Bulk Payslip Extra Fields
    asset_damage_recovery = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    cash_advance_settlement = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    cess = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    city_compensatory_allowance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    employee_gratuity = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    employee_gratuity_contribution = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    employee_pf_abry = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    employer_pf_abry = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    final_settlement = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    food_coupons = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    general_expenses = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    joining_bonus = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    notice_period_buyout = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    nps_employer = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    over_time = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    professional_allowance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    shift_allowance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    surcharge = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    voluntary_pf = models.DecimalField(max_digits=12, decimal_places=2, default=0)
