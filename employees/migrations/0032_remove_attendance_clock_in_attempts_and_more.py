    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                default=0, help_text="Number of clock-in/out sessions today"
            ),
        ),
        migrations.AddField(
            model_name="attendance",
        ...
        migrations.AddField(
            ...
            field=models.FloatField(
                default=0.0, help_text="Total break time between sessions"
            ),
        ),
        migrations.AddField(
            model_name="attendance",
            ...
            field=models.FloatField(
                default=0.0, help_text="Total working hours for the day"
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session_type",
                    models.CharField(
                        choices=[("WEB", "Web/Office"), ("REMOTE", "Remote/WFH")],
                        max_length=10,
                    ),
                ),
                (
                ...
                (
                    "duration_hours",
                    models.FloatField(
                        default=0.0, help_text="Duration of this session in hours"
                    ),
                ),
                (
                    "user_timezone",
                    models.CharField(default="Asia/Kolkata", max_length=50),
                ),
                (
                    "attendance",
                    models.ForeignKey(
