...
class LeaveApplicationForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if duration in ["FIRST_HALF", "SECOND_HALF"] and start_date and end_date and start_date != end_date:
        ...
        if self.user and self.user.company:
            ...
            if ("bluebix" in company_name or "softstand" in company_name) and leave_type == "SL" and duration != "HALF":
