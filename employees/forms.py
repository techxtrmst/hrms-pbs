...
class EmployeeCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            # Job
            'designation', 'department', 'manager', 'location', 'work_type', 'assigned_shift', 'date_of_joining',
            # Finace
...
class LeaveApplicationForm(forms.ModelForm):
    class Meta:
        model = LeaveRequest
        fields = ['leave_type', 'start_date', 'end_date', 'duration', 'reason', 'supporting_document']
        widgets = {
...
class RegularizationRequestForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'reason': forms.Textarea(attrs={'class': 'form-control', 'rows': 3, 'placeholder': 'Reason involves missing punch, system error, etc.'}),
        }
