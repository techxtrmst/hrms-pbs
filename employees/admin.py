...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ('user', 'company', 'department', 'designation', 'manager', 'badge_id')
    list_filter = ('company', 'department', 'designation', 'employment_status', 'is_active')
...
class EmergencyContactAdmin(admin.ModelAdmin):
    ...
    search_fields = ('employee__user__first_name', 'employee__user__last_name', 'name', 'phone_number')
