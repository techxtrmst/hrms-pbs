...
from employees.models import ExitInitiative
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        exit_initiatives = ExitInitiative.objects.filter(
            status="APPROVED", last_working_day__lte=today, employee__is_active=True
        )
        ...
        if processed_count == 0:
            ...
            self.stdout.write(self.style.SUCCESS(f"Successfully processed {processed_count} employee exit(s)."))
