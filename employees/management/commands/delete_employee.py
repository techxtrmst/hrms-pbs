...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            # Confirm deletion
            self.stdout.write(self.style.WARNING(f"Are you sure you want to PERMANENTLY DELETE current user {user.email} and ALL related data (Employee profile, Attendance, Leaves, etc.)?"))
